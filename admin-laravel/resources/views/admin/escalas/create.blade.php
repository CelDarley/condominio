...
<div class="row">
    <div class="col-md-8 mx-auto">
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('admin.escalas.store') }}">
                    @csrf
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <select class="form-control @error('cartao_programa_id') is-invalid @enderror" 
                                    ...
                                    <option value="">Primeiro selecione um posto de trabalho</option>
                                </select>
...
// Carregar cartões programa se há um posto já selecionado (para old values)
